class ProfileCell < UITableViewCell
  ...
  def createLabels
    ...
    @date_label.font = :bold.uifont(17)
    ...
    @steals_label.font = :bold.uifont(27)
    ...
    @blocks_label.font = :bold.uifont(27)
    ...
    @infoR_label.font = :bold.uifont(9)
    ...
    @infoS_label.font = :bold.uifont(9)
    ...
    @infoB_label.font = :bold.uifont(9)
    ...
    @infoF_label.font = :bold.uifont(9)
